...
MODEL_PREFLIGHT_PROTOCOL_VERSION = "tiago_tool_center_toll_v4_model_preflight_v4_1"
...
REJECTED_V3_LAUNCH_REPORT_ONLY = {
    ...
    "downstream_call_counts": dict(REJECTED_V3_EXPECTED_DOWNSTREAM_CALL_COUNTS),
}
...
REQUIRED_SOURCE_PATHS = {
    "preflight_schema": "tiago_src/gato_tiago/multimodal_toll_v4_model_preflight_v4.py",
    "preflight_runner": "tiago_src/gato_tiago/multimodal_toll_v4_model_preflight_v4_runner.py",
    "preflight_worker": "tiago_src/gato_tiago/multimodal_toll_v4_model_preflight_v4_worker.py",
    "preflight_tests": "tests/python/test_tiago_multimodal_toll_v4_model_preflight_v4.py",
