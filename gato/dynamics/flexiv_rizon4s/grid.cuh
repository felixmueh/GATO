...
namespace grid {
    ...
    const int ID_DYNAMIC_SHARED_MEM_COUNT = 546;
    const int MINV_DYNAMIC_SHARED_MEM_COUNT = 1171;
    const int FD_DYNAMIC_SHARED_MEM_COUNT = 1220;
    const int ID_DU_DYNAMIC_SHARED_MEM_COUNT = 2226;
    const int FD_DU_DYNAMIC_SHARED_MEM_COUNT = 2226;
    const int ID_DU_MAX_SHARED_MEM_COUNT = 2471;
    const int FD_DU_MAX_SHARED_MEM_COUNT = 2625;
    ...
    void forward_dynamics_inner(T *s_qdd, const T *s_q, const T *s_qd, const T *s_u, T *s_XImats, int *s_topology_helpers, T *s_temp, const T gravity) {
        ...
        inverse_dynamics_inner<T>(&s_temp[49], &s_temp[56], s_q, s_qd, s_XImats, s_topology_helpers, &s_temp[182], gravity);
