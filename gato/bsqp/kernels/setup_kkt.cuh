                                            ...
                                            T     ctrl_lim_cost)
{
        ...
        for (uint32_t knot_idx = blockIdx.x; knot_idx < KNOT_POINTS - 1; knot_idx += gridDim.x) {
                ...
                if (knot_idx < KNOT_POINTS - 2) {
                        ...
                        gato::plant::trackingCostGradientAndHessian<T>(STATE_SIZE, CONTROL_SIZE, s_xux_k, s_reference_traj_k, s_Q_k, s_q_k, s_R_k, s_r_k, s_temp, d_GRiD_mem, q_cost, qd_cost, u_cost, N_cost, ee_orient_cost, ee_orient_N_cost, q_lim_cost, vel_lim_cost, ctrl_lim_cost);
                        ...
                        gato::plant::trackingCostGradientAndHessian_lastblock<T>(
                            STATE_SIZE, CONTROL_SIZE, s_xux_k, s_reference_traj_k, s_Q_k, s_q_k, s_R_k, s_r_k, s_Q_last, s_q_last, s_temp, d_GRiD_mem, q_cost, qd_cost, u_cost, N_cost, ee_orient_cost, ee_orient_N_cost, q_lim_cost, vel_lim_cost, ctrl_lim_cost);
...
__host__ void setupKKTSystemBatched(KKTSystem<T, BatchSize> kkt, ProblemInputs<T, BatchSize> inputs, T* d_xu_traj_batch, T* d_f_ext_batch, void* d_GRiD_mem, T q_cost, T qd_cost, T u_cost, T N_cost, T ee_orient_cost, T ee_orient_N_cost, T q_lim_cost, T vel_lim_cost, T ctrl_lim_cost, cudaStream_t stream)
{
