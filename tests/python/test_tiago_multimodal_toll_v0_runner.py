...
def test_rejected_v0_runner_cannot_cross_runtime_boundary(tmp_path, monkeypatch):
...
def test_rejected_v0_worker_cannot_cross_runtime_boundary(tmp_path, monkeypatch):
