...
def test_p3_cpu_capabilities_are_closed_after_accepted_run_and_reports_are_exact():
    ...
    assert enabled=={
        ("circular_portfolio_p4_runner.py","RUNNER_EXECUTION_AUTHORIZATION=object()"),
        ("circular_portfolio_p4_worker.py","WORKER_EXECUTION_AUTHORIZATION=object()")}
