...
GENERATOR_RELATIVE_PATH = Path(__file__).resolve().relative_to(REPO_ROOT)
...
// Generated by {GENERATOR_RELATIVE_PATH} from the native Tiago URDF.
...
def require_grid_python_deps() -> None:
    ...
    raise SystemExit(
        ...
        + f"  {GRID_VENV / 'bin' / 'python'} {GENERATOR_RELATIVE_PATH}"
    )
